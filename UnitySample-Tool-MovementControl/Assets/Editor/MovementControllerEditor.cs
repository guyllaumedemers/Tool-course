...
{ //Extends Editor required
    ...
    private SerializedProperty wpArray;
    ...
    public void OnEnable()
    {
        ...
        wpArray = movementCntrl.FindProperty("waypoints");
    }
    ...
    {
        wpArray.GetArrayElementAtIndex(index).DuplicateCommand();
    }
    ...
    private void Clear()
    {
        ...
        do
        {
            ...
            {
                if (wpArray.GetArrayElementAtIndex(i).objectReferenceValue == null)
                {
                    wpArray.GetArrayElementAtIndex(i).DeleteCommand();
                    hasEmptyEntries = true;
                    break;
                }
            }
        } while (hasEmptyEntries);
    }
    ...
    public override void OnInspectorGUI() //Must be overwritten, this is called everytime the mouse moves over the inspector
    {
        ...
        for (int i = 0; i < wpArrayCount.intValue; i++)
        {
            ...
            GUI.enabled = result != null && initialEnabledSetting ? true : false;
    ...
    private void OnSceneGUI() //Monobehaviour editor function
    {
        ...
        if (mc.waypoints.Length > 1 && mc.waypoints[mc.waypoints.Length - 1] != null && mc.waypoints[0] != null)
        {
